        ...
        <form method="post" id="gameForm">
            <div class="color-grid">
                <?php foreach ($colors as $color): ?>
                    <label class="color-option">
                        <input type="radio" name="color" value="<?php echo $color; ?>" <?php echo ($chosen_color == $color) ? 'checked' : ''; ?>>
            ...
            <div class="bet-panel">
                ...
                <div class="bet-buttons">
                    <button type="submit" name="adjust" value="-100">-100</button>
                    <button type="submit" name="adjust" value="-10">-10</button>
                    <button type="submit" name="adjust" value="+10">+10</button>
                    <button type="submit" name="adjust" value="+100">+100</button>
                </div>
                <div class="minmax">
            ...
            <button type="submit" name="action" value="confirm_bet" class="confirm-btn">CONFIRM BET</button>
        </form>
    </div>
