...
.header-left, .header-right {
    width: 200px; padding: 0 22px;
    color: var(--warm-champagne);
    font-size: 0.9rem; font-family: var(--sans);
    display: flex; align-items: center; gap: 9px; line-height: 3rem;
}
.header-left  { justify-content: flex-start; }
.header-right { justify-content: flex-end; }
.user-icon {
    width: 34px; height: 34px; border-radius: 50%;
    background: #0E0500; border: 1.5px solid var(--burnished-gold);
    display: flex; align-items: center; justify-content: center; font-size: 1.1rem;
}
.balance-amount { font-weight: bold; color: var(--burnished-gold); font-family: var(--sans); }
header h1 {
    color: var(--burnished-gold);
    font-family: 'Times New Roman', serif;
    font-size: 2.8rem; letter-spacing: 4px; font-weight: normal;
...
.bet-preview span { color: var(--burnished-gold); font-weight: bold; }
                ...
                <?php if (!$_SESSION['dice_active']): ?>
                    ...
                    <form method="post">
                        ...
                        <div class="bet-preview">
                            Betting &#8369;<span id="betValue"><?php echo isset($_POST['bet']) ? htmlspecialchars($_POST['bet']) : '10'; ?></span>
                        </div>
                    ...
                    <script>
                        ...
                        if (betInput && betSpan) {
                            betInput.addEventListener('input', function() { betSpan.textContent = this.value; });
                        }
                    </script>
            ...
            <div class="result-panel">
                ...
                <div class="action-buttons">
                    ...
                    <form method="post" style="display:inline;">
                        ...
                        <button type="submit" class="btn-secondary">END THE GAME</button>
                    </form>
                </div>
                <?php endif; ?>
